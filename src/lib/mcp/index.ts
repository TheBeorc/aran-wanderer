...
export default defineMcp({
  ...
  title: "Aran Rover 2026",
  version: "0.1.0",
  instructions:
    "Tools for the Aran Rover 2026 illustrated field guide to the Aran Islands (Inishmore, Inishmaan, Inisheer). Use `list_pois` to browse points of interest (optionally filtered by island or icon type), `search_pois` for full-text search across names, folklore and nature notes, and `get_poi` to fetch the full entry for a specific place.",
